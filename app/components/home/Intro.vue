...
<template>
  <div class="space-y-6">
    <NuxtImg
      src="/avatar.jpg"
      alt="Arthur Dufour"
      class="size-12 rounded-full border border-neutral-300 bg-neutral-200 ring-2 ring-neutral-200 transition-all duration-300 hover:ring-4 sm:size-16 dark:border-neutral-800 dark:bg-neutral-900 dark:ring-white/10"
      sizes="48px sm:64px"
      format="webp"
      placeholder
    />
